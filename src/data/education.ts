export const educationExperience = [
    {
        year: '2023 - Current',
        yearES: '2023 - Actualidad',
        institution: 'University of Minnesota - Twin Cities',
        institutionES: 'Analista de Sistemas',
        degree: 'Ph.D. in Computer Science',
		location: 'Minneapolis, MN',
        description: 'Advisor: Dr. Yao-Yi Chiang',
		...
		highlights: [
			...
			activities: [
			{
				...
				items: [
					{ text: 'CSCI5541: Natural Language Processing', meta: 'Spring 2026' },
	...
	},
    {
        ...
        yearES: '2023 - 2025',
        institution: 'University of Minnesota - Twin Cities',
        institutionES: 'Desarrollador Fullstack',
    ...
    },
    {
        ...
        institutionES: 'Desarrollador y Consultor de TI Freelance',
        degree: 'M.Eng in Electrical Engineering',
		location: 'New York, NY',
        description: 'Advisor: Dr. Carl Sable',
